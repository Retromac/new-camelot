<template>
    ...
    <section class="bg-blueW">
        <div class="box-container flex justify-between w-full max-w-box mx-auto items-center">
            <div class="col basis-2/4 px-3.5">
                <h1 class="text-4xl">Φίλτρα νερού βρύσης Camelot<sup>®</sup> για καθαρό φιλτραρισμένο νερό</h1>
                <p class="text-xl">Τα <b>φίλτρα νερού βρύσης Camelot®</b> σας παρέχουν καθαρό φιλτραρισμένο νερό για να
            ...
            <div class="col basis-2/4 bg-white">
                <img src="../assets/images/badge_usa.svg" alt="">
                <img src="../assets/images/imperial-plus.webp" alt="">
                <p class="text-blueL text-3xl text-center font-semibold	px-3">
                    Φίλτρα Νερού Βρύσης Imperial Plus 5ης γενιάς
                </p>
                <div class="border_box bg-gradient-to-r from-cyan-500 to-blue-500 p-1 width-full"></div>
            </div>
        </div>
